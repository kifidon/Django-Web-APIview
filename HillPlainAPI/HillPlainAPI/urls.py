...
from BackgroundTasks.views import *
...
# Clockified Scheduled tasks
    ...
    path('quickBackup/<str:event>', QuickBackup , name = 'quickBackup'),
    path('timesheet/<str:offset>', detailedTimesheetBackup),
...
# ReportGenerator App
    ...
    path('bankedDetails', TimeOffReport),
    path('bankedDetails/<str:startDate>/<str:endDate>/', TimeOffReport),
...
#Hill Plain internal Clockify API
    path('HpClockifyApi/TimeSheets', TimesheetsView.as_view(), name = 'clockifyTimesheet'),
    # path('HpClockifyApi/Clients', ClientsView),
    path('HpClockifyApi/Users', EmployeeUserView.as_view(), name = 'Users'),
    path('HpClockifyApi/TimeOff', TimeoffRequestsView.as_view(), name='TimeOff'),
    # path('HpClockifyApi/Policies', TimeOffPoliciesView),
    path('HpClockifyApi/Projects', ProjectsView, name='projects'),
    path('HpClockifyApi/Entry', EntryView.as_view(), name="clockifyEntry"),
    ...
    path('HpClockifyApi/task/Entry', EntryView.as_view()),
